        ...
        if 'E' in df.columns and 'N' in df.columns:
            ...
            with tab_map:
                ...
                if lats is not None:
                    ...
                    # 2. Tambah Label Bering & Jarak di Tengah Garisan
                    ...
                    # 3. Tambah Marker Stesen (Bulatan Merah + No Putih)
            ...
            with tab_plot:
                ...
                e_p, n_p = zip(*coords)
                ax.plot(e_p, n_p, marker='o', color='black')
